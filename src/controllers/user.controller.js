...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Password channged successfully"));
});
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  if (!fullName || !email) {
    throw new ApiError(400, "Email and fullname required");
  }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  if (!avatarLocalPath) {
    throw new ApiError(400, "Cover Image file is not given.");
  }
